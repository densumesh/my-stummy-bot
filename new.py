...
class Music(commands.Cog):
    def __init__(self, bot):
        ...
        if not hasattr(client, 'lavalink'):  # This ensures the client isn't overwritten during cog reloads.
            ...
            client.lavalink.add_node('0.0.0.0', 2333, 'youshallnotpass', 'us-central', 'default-node')  # Host, Port, Password, Region, Name
...
client.run('NzI3MjU2NjkxMzIxODY0MjUz.XxhqeQ.QgIWR5b0HmF94wDqSpwmyaKH7Kw')